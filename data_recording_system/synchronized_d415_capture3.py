...
def main():
    ...
    try:
        ...
        # Setup platform cameras - try multiple IDs
        platform_ids_to_try = [0, 1, 2, 3, 4]
        print(f"🔧 Testing platform cameras {platform_ids_to_try}...")
        
        for cam_id in platform_ids_to_try:
